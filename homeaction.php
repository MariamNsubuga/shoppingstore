...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li><a href='store.php'>Birds</a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
                               ...
                               <li class='categoryhome' cid='$cid'><a href='store.php'style='font-family: 'Times New Roman';'><b>$cat_name</b></a></li>
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>Shs $pro_price<del class='product-old-price'></del></h4>
									</div></a>
								</div>
