...
<body>
  ...
  <h1>Confirmed  Delivery Orders<?php echo $page;?> </h1></div><br>
<div class='table-responsive'>  
<div style="overflow-x:scroll;">
<table class="table  table-hover table-striped" style="font-size:15px">
<tr><th>Customer Name</th><th>Order</th><th>Contact | Email</th><th>Address</th><th>Amount</th><th>DeliveryMode</th><th>Time</th><th>Action</th><th></th></tr>
<?php 
$status="Confirmed";

$result=mysqli_query($con,"select id_user, order_list,total,delivery_mode,date, first_name,last_name, mobile, email, address1, address2 from orders,user_info where user_info.user_id=orders.id_user Limit $page1 where orders.status='$status',10")or die ("query 1 incorrect.....");

while(list($order_id,$order_list,$total,$delivery_mode,$date,$firstname,$lastname,$mobile,$email,$address1,$address2)=mysqli_fetch_array($result))
{ 
...
echo "<tr><td>$firstname $lastname</td><td>$order_list</td><td>$mobile<br>$email</td><td>$address1<br>$address2</td><td>$total</td><td>$delivery_mode</td><td>$date</td>
