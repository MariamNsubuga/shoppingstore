...
<body>
  ...
  <h1>Confirmed Mobile Money Orders <?php echo $page;?> </h1></div><br>
...
$status="Confirmed";
$result=mysqli_query($con,"select id_user, order_list,total,sender_number,date, first_name,last_name, mobile, email, address1, address2 from mm_order,user_info where user_info.user_id=mm_order.id_user Limit $page1 where mm_order.status='$status',10")or die ("query 1 incorrect.....");
