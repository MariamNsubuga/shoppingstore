...
<tr><th>Image</th><th>Name</th><th>Category</th><th>Price</th><th>
  <a class=" btn btn-primary" href="add_product.php">Add New</a></th></tr>
<?php 

$result=mysqli_query($con,"select product_id,product_image,product_title,product_cat,product_price from products  Limit $page1,10")or die ("query 1 incorrect.....");

while(list($product_id,$image,$product_name,$product_cat,$price)=mysqli_fetch_array($result))
{
