...
<body>
  ...
  <h1>Payment on Delivery Orders<?php echo $page;?> </h1></div><br>
...
$result=mysqli_query($con,"select id_user, order_list,total,delivery_mode,date, first_name,last_name, mobile, email, address1, address2 from orders,user_info where user_info.user_id=orders.id_user Limit $page1,10")or die ("query 1 incorrect.....");
